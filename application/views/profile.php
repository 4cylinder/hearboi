...
<form enctype="multipart/form-data" id="userForm" action='<?=base_url();?>user/save' method='post'>
	<div class="container text-center">
		...
		<div class="col-md-9">
			<div class="row">
				...
				<div class="col-md-3"><input class="form-control input-sm" placeholder="FIRST NAME" value="<?=$user->fname; ?>" type="text" name="fname" id="fname" required></div>
				<div class="col-md-3"><input class="form-control input-sm" placeholder="LAST NAME" value="<?=$user->lname; ?>" type="text" name="lname" id="lname" required></div>
			</div>
			<div class="row">
